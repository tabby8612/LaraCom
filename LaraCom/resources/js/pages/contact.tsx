    ...
    return (
        <>
            ...
            <div className="mx-20 my-16 max-h-full min-h-16">
                ...
                <p className="my-5 font-Rubik text-lg text-bodyText">
                    If you prefer an in-person shopping experience, we invite you to visit our physical store. Our knowledgeable staff will be happy
                    to assist you and guide you through our products.
                </p>
                <h1 className="font-Rubik text-2xl font-bold text-heading uppercase">Social Media</h1>
                <p className="my-5 font-Rubik text-lg text-bodyText">
                    Stay connected with LARACOM on social media! Follow us for the latest shoe trends, exclusive offers, and customer testimonials.
                    Join the LARACOM community today for fashion inspiration and more.
                </p>
            </div>
            <div
                id="contact-form"
