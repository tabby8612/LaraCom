            ...
            <ScrollProgress>
                ...
                <div className="mx-5 my-12 flex max-h-full min-h-96 gap-4 rounded-xl bg-gradient-to-r from-purple-200 to-purple-300 px-4 py-5">
                    <div className="w-1/2 px-5 py-3 font-Rubik">
                        ...
                        <p className="mb-8">
                            We are committed to bringing you the latest and most trusted tech products — from cutting-edge laptops and sleek
                            smartphones to smart accessories that elevate your life. Every product we offer is handpicked for quality, value, and
                            innovation. <span className="font-bold">Because when it comes to tech, you deserve the best — no compromises.</span>
                        </p>
