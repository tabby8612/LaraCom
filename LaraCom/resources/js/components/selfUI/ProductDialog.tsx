...
export default function ProductDialog({ image, name, sku, status, category, date, price, closeFn, addItemFn }: Props) {
    return createPortal(
        <div className="fixed inset-0 z-[999] flex max-h-full items-center justify-center bg-black/50 pt-20" onClick={closeFn}>
            <div className={`relative mx-5 my-auto w-8/12 rounded-lg bg-white p-6 shadow-[0px_0px_10px_10px_#000] delay-200 duration-300 animate-in`}>
                ...
                <div className="flex gap-20 px-5 py-5">
                    <div className="mx-auto flex w-3/4 flex-col items-center justify-center">
                        <img src={`${image}`} alt={name} className="size-44 transition-transform delay-200 duration-300 hover:scale-105 md:w-full" />
                        ...
                        <div className="my-10 flex gap-6">
                            <div className="mx-auto w-1/2 rounded-xl bg-pink-200 px-4 py-3 text-center shadow-lg">
                                ...
                                <p className="font-semiboldbold text-md font-Rubik text-stone-400">$ {price}</p>
                            </div>
                            <div className="mx-auto w-1/2 rounded-xl bg-pink-200 px-4 py-3 text-center shadow-lg">
                                <h1 className="font-Rubik text-2xl font-bold">abc</h1>
                                <p className="font-semiboldbold text-md font-Rubik text-stone-400">goodadasd</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex w-11/12 flex-col justify-between rounded-xl bg-pink-200 px-5 py-2">
                        <div>
                            ...
                            <h2 className="my-5 font-Rubik text-xl font-bold md:text-2xl">
                                <span className="font-medium text-black/50">Product ID:</span> {sku}
                            </h2>
